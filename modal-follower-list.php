                ...
                ?>
                      ...
                      <div class="col-6 text-center">
                          <div class="text-center margin-top-15">
                              <a href="/user/<?php echo $getterNameFollower['username']; ?>" class="my-links">
                                  <span class="badge bg-light text-dark font-16">
                                      <img
                                          style="border-radius: 100%;"
                                          src="/assets/img/profile_photos/<?php echo $getterNameFollower["profile_photo"]; ?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              ?>
                      ...
                      <div class="col-6 text-center">
                          <div class="text-center margin-top-15">
                              <a href="/user/<?php echo $getterNameFollowing['username']; ?>" class="my-links margin-top-15">
                                  <span class="badge bg-light text-dark font-16">
                                      <img
                                          style="border-radius: 100%;"
                                          src="/assets/img/profile_photos/<?php echo $getterNameFollowing["profile_photo"]; ?>"
                                          width="40px" height="40px" />
